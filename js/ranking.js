    ...
    if (btnSaveResults) {
        btnSaveResults.addEventListener('click', async () => {
            try {
                ...
                // 显示经过美化的成功提示框，单行不换行
                const successIcon = '<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" class="animate-icon" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>';
                const successMessage = '<div style="display: flex; align-items: center; justify-content: center; white-space: nowrap;"><strong style="color: #ffffff; font-size: 1.05em; margin-right: 6px;">保存成功！</strong><span style="color: #ffffff;">先要做<strong style="color: #ffffff;">【福利排品】</strong>，然后再做【排品推送】。</span></div>';
